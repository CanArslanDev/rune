...
Current release: **v1.7.0**. Gesture primitives: Draggable / LongPressDraggable / DragTarget for drag-and-drop, Dismissible for swipe-to-dismiss, InteractiveViewer for pan-and-zoom, ReorderableListView for drag-to-reorder. ValueKey value builder plus ListTile.key slot support stable-identity children.
