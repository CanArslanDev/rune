...
Current release: **v1.1.0**. StatefulBuilder lifecycle closures (initState / dispose / didUpdateWidget) plus source-level controller value builders (TextEditingController, ScrollController, FocusNode, PageController) wired through TextField, ListView, ScrollViews, and TabBar. Source can now own the full lifecycle of its own controllers.
