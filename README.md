...
Current release: **v1.0.0**. Stateful source end-to-end: closures, block bodies with local scope, source-level state via `StatefulBuilder`, `setState` sugar with property-access assignment, and named reusable components. API stable for early pub.dev adopters.
