...
Current release: **v1.8.0**. DataTable + DataColumn / DataRow / DataCell for structured tabular display, ExpansionTile + ExpansionPanelList for collapsible sections, and Stepper + Step for multi-step flows. Column sorting, expansion toggles, and step advancement all driven by source-level closures.
