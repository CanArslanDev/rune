...
Current release: **v1.6.0**. Navigator imperative bridges (push, pushReplacement, pushNamed, canPop) plus MaterialPageRoute / CupertinoPageRoute / RouteSettings value builders. Source can now push and pop routes entirely in the string.
