...
void main() {
  group('CupertinoPageRouteBuilder', () {
    const b = CupertinoPageRouteBuilder();

    test('typeName is "CupertinoPageRoute" and constructorName is null', () {
      expect(b.typeName, 'CupertinoPageRoute');
    ...
    test('valid builder produces a CupertinoPageRoute with defaults', () {
    ...
    test('title, fullscreenDialog, maintainState, settings plumb through', () {
      final closure = _closureOf("(ctx) => Text('Detail')");
      ...
      expect(route.title, 'Detail Page');
